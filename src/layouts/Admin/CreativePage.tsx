...
} from "../../app/api/Taskspot/creative";
import type { ServiceRequest } from "../../app/api/Taskspot/creative";
...
export default function CreativeAdmin() {
  const { data, isLoading, isError } = useGetAllCreativeRequestsQuery();
  const [deleteRequest] = useDeleteCreativeRequestMutation();
